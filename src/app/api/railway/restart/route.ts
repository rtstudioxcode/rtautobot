...
import { bonustimeTenantLookup, bonustimeSharedServiceName } from '../../../../services/bonustimeMultiTenant';
...
async function railwayQuery(query: any, variables: any = {}): Promise<any> {
...
async function fetchRailwayServices() {
  ...
  const result: any = await railwayQuery(`
...
export async function POST(request) {
  try {
    ...
    for (const q of [
      ...
      try {
        const result: any = await railwayQuery(q.query, q.variables);
