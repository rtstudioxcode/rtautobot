...
const BonustimeOrderSchema = new mongoose.Schema({
  ...
  legacyTenantId: { type: String, index: true },
...
export const BonustimeOrder: any = mongoose.models.BonustimeOrder || mongoose.model("BonustimeOrder", BonustimeOrderSchema);
