...
const TelegramJobSchema = new mongoose.Schema({
  ...
  // Legacy fields: TelegramBot ไม่รวมกับ spend/level/points แล้ว แต่เก็บไว้เพื่อไม่ให้ข้อมูลเก่าพัง
  tgSpentAccounted: { type: Number, default: 0 },
  tgSpentAccountedAt: { type: Date },
});
