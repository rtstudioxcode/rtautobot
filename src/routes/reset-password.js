...
router.post('/password/forgot', async (req, res) => {
  try {
    ...
    glog.error('forgot password error:', e);
...
router.post('/password/reset', async (req, res) => {
  try {
    ...
    const doc = await OtpToken.findOneAndUpdate(
      { _id: grant.tokenId, email: grant.email, purpose: 'password-reset-link', usedAt: null },
      { $set: { usedAt: new Date() } },
      { new: false } // return old doc to confirm it was found unused
    );
    ...
    glog.error('reset password error:', e);
