...
import { MacroDroidInbox } from "../models/MacroDroidInbox.js";
...
function payloadToPlainRaw(raw = {}) {
  if (typeof raw === "string") return raw;
  try { return JSON.stringify(raw); } catch { return String(raw || ""); }
}

export function buildMacroDroidInboxPayload(req, options = {}) {
...
export async function storeMacroDroidInbox(req, options = {}) {
